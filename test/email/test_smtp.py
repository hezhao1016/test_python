...
from_addr = 'xxx@foxmail.com'  # 发送人
password = '请输入密码'  # 密码
to_addr = 'xxx@163.com'  # 收件人
...
msg = MIMEText('<html><body><h1 style="color:red;">Hello</h1>' +
...
# 邮件正文 插入图片 cid:0
msg.attach(MIMEText('<html><body><h1 style="color:yellow;">Hello</h1>' +
    '<p><img src="cid:0"></p>' +
    '</body></html>', 'html', 'utf-8'))
