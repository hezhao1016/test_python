...
# 获得job列表
# job = scheduler.add_job(my_job, 'interval', seconds=2 ,id='123')
...
day_of_week(int | str) – number or name of weekday(0 - 6 or mon, tue, wed, thu, fri, sat, sun) - （表示一周中的第几天，既可以用0 - 6 表示也可以用其英语缩写表示）
...
# 参考网址：https://www.cnblogs.com/luxiaojun/p/6567132.html
